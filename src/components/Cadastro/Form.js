...
export function FormGroup(props){
    ...
    <label className="input-group" htmlFor={ id } > { titulo }{ require && <span className="text-danger">*</span> }</label>
            <Field type={ type } className="form-control" placeholder={ placeholder } name={ id } id={ id }/>
